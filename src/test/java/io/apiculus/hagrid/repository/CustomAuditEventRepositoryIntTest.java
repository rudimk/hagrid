package io.apiculus.hagrid.repository;

import io.apiculus.hagrid.HagridApp;
import io.apiculus.hagrid.config.Constants;
import io.apiculus.hagrid.config.audit.AuditEventConverter;
import io.apiculus.hagrid.domain.PersistentAuditEvent;
...
import static io.apiculus.hagrid.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
